...
%Por supuesto, mi interpretación de los sentimientos de Aquiles ni es única ni tiene por qué ser la más acertada, pero lo que importa es que se basa en los mismos hechos que se describen en la \emph{Ilíada}. Héctor mata a Patroclo. Aquiles mata a Héctor y mancilla, furioso, el cadáver de su enemigo vencido, un acto que poco tiene que envidiar, en brutalidad, a las atrocidades del canto XXII de la \emph{Odisea}. Pero cuando Príamo pide el cuerpo de Héctor, Aquiles se apiada de él y se lo devuelve para que pueda ofrecerle las honras fúnebres que se merece. Y esa nobleza reverbera para siempre en nuestra memoria colectiva. 
