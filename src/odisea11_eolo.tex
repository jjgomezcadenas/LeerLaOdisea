...
¿Por qué Odiseo no entra en el puerto como las demás naves tomando exactamente la decisión contraria a la que tomó en la isla de los cíclopes? ¿Teme algo o es su naturaleza desconfiada y siempre alerta? La ensenada es a la vez un puerto seguro y una trampa, una de tantas trampas de las que escapa el héroe, quizás por suerte, quizás por una de sus oportunas corazonadas.
