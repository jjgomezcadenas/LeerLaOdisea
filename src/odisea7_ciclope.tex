\odiseachapter{Séptima parte}{Cíclope}\label{cap:ciclope}
...
El Polifemo del amigo Christopher tiene un eco de este muchacho retrasado que describe el poema\footnote{Y por si algún malpensado se lo está preguntando, \emph{Abandonando Ítaca} se publicó un año antes de que se estrenara la película de Nolan.}. El problema no es un cíclope estúpido, sino la falta de ambición para sacarle partido. El Polifemo de Nolan hace lo mismo que el de Homero y no aporta nada a la versión original, mucho más interesante. Pero elimina el architruco de Ulises y apunta a que este se enemista con Poseidón en un acto de justa venganza: le lanza una flecha al cíclope, provocando la ira del dios ---como si haberle sacado un ojo a su chico un rato antes no fuera suficiente--- por sus hombres asesinados, cuando el propio héroe cuenta, en la corte de Alcínoo, que lo hace por pura arrogancia.
