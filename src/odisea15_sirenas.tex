\odiseachapter{sirenas}{Sirenas}\label{cap:sirenas}

Poco cuesta imaginar un concilio de los olímpicos, similar a los que nos presenta Homero, en el que los inmortales debaten qué hacer con Nolan.

---Al Tártaro con él ---exclama Atenea---. Es imperdonable que me haya convertido en una psiquiatra \emph{new age}.

---Deberíamos ponerlo de ayudante de Sísifo ---interviene Apolo---. A ver si aprende a no pintar a los héroes con brocha gorda.

---Con vuestro permiso, yo lo convertiría en algún animalito para hacerme compañía ---propone Circe---. Así se entera de cómo se debe tratar a las deidades.

---No seáis energúmenos ---dice Calipso---. Yo me lo quedo una temporada, me sobra un poco de flor de loto.
...
¿Qué escena es esa? 
Ulises ha recordado a las sirenas, sabe cómo se sintió atado al mástil y está convencido de que Nolan ha sido capaz de capturar exactamente aquella sensación. Mejor aún, se da cuenta de que, en este caso, el cine es capaz de superar la palabra escrita, al menos durante unos instantes.

Hablando de palabra escrita, retomemos el viaje de nuestro héroe en el capítulo~\ref{cap:voz}, cuando él y sus hombres regresan a la isla de Circe, después de haber escapado del Hades.
...
Después de dejar atrás a las sirenas, le esperan Escila y Caribdis. Pagado el mortal peaje, queda la isla de Trinacia, donde campean las vacas del Sol, que ni él ni su tripulación deben tocar. También sabemos lo que le dice:
...
Esa era otra de las cuentas que yo tenía pendientes con el granbardo. En \emph{Abandonando Ítaca}, escribo mi propia versión:
...
Podía ser por la muerte de Héctor, o la muerte de Aquiles,\\
...
pero siempre se lamentaba. Los hombres solo se redimen\\
cuando cantan lo que han perdido.
\end{versopropio}

Y es justamente de ese sentido de lo sagrado del que se alimentan las sirenas:

\begin{versopropio}
Quizás esto es lo que hizo que las sirenas\\
fuesen tan temibles y tan peligrosas,\\
sabían cantar las canciones de los hombres\\
con la voz de Circe.
\stanzabreak
Oh, cómo lloraste atado al mástil de la embarcación,\\
escuchando sus acordes, mientras tu tripulación las ignoraba,\\
sordos a su hechizo. Y, sin embargo, lo volverías a hacer mil veces más.\\
Si tu viaje tenía alguna justificación,\\
si pasar entre Escila y Caribdis valía el riesgo,\\
si luchar contra cíclopes y lestrigones tenía sentido,\\
...
Vacías de dioses, pero llenas de gracia. Odiseo ha necesitado llegar a la senectud para entender el canto de las sirenas.
