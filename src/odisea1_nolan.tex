\odiseachapter{Primera parte}{El cine teme a Homero}
...
Puede argumentarse que sir Christopher está en su derecho de reinterpretar el personaje de Helena y no seré yo quien discrepe, ya que yo mismo lo hago sin vergüenza alguna en \emph{Abandonando Ítaca}.
...
Podríamos seguir con otros muchos detalles. A Telémaco, por ejemplo, nos lo pinta como un \emph{boy scout} y veremos en el capítulo XIV que de \emph{boy scout} no tiene nada; es digno hijo de su padre en fuerza y crueldad. De Circe hablaremos en el capítulo IX y ruego a los olímpicos que no se tomen a mal que nuestro atrevido director haya transformado a la diosa beltrenza en una tabernera ---como en los otros casos, restándole, no añadiéndole atributos---. Calipso (capítulo V) no sale tan mal parada si le perdonamos que empache a su huésped con flores de loto.
