...
Homero escribe \gr{ἕλε τρόμος} (héle trómos) que se traduce por le entró el temblor) y \gr{φοβηθείς} (huyendo aterrado). No hay duda alguna. Héctor ha visto cómo el asesino armado hasta los dientes se le echa encima, no ha podido controlar el pánico y se ha dado a la fuga.
...
Puede argumentarse que sir Christopher está en su derecho de reinterpretar el personaje de Helena y no seré yo quien discrepe, ya que yo mismo lo hago sin vergüenza alguna en \emph{Abandonando Ítaca}\footnote{\url{https://eolasediciones.es/libro/abandonando-itaca-leaving-ithaca/}}.
%En mi propia versión del mito de Odiseo, reinterpreto esencialmente toda la vida y la personalidad del héroe.
Reescribir al clásico no solo es necesario: es, hasta cierto punto, inevitable. Pero hay que decir que el jaleado director se complica poco la vida: el navajazo en el rostro de la bella es un cliché tan trillado como el fornido Eric Bana plantándole cara sin miedo al no menos fornido Brad Pitt. Y resulta irónico que un texto del siglo VIII a.C. ofrezca una lectura inquietante y subversiva de Helena de Troya ---Homero dibuja una semidiosa amoral que sobrevive sin mayores remordimientos a la catástrofe que causó--- mientras que Nolan ofrece algo mucho más convencional y comercial a la vez: la víctima cuya cicatriz reconocemos y con la que podemos identificarnos. Exactamente igual que hace Petersen. ¿Para qué arriesgarse a que los espectadores crean que Héctor es un cobarde, si podemos suprimir la carrera?

Otro ejemplo. En la \emph{Odisea}, el gamberro y malvado Polifemo es \emph{casi} tan artero como el propio Ulises. En la versión de Nolan, el cíclope es un idiota casi mudo.

¿Es lícito ese cambio de papeles? Nada lo impide a priori y, de hecho, en mi propio poema imagino a Polifemo como un muchacho gentil y ligeramente retardado. Pero no me limito a eso; también desarrollo el personaje y reinterpreto su relación con el taimado héroe. Todo lo que Nolan nos ofrece son unas escenas de acción, por lo demás, bien rodadas.
...
Bueno, ¿y qué? Para gustos, los colores y lo cierto es que la película es entretenida y bellamente filmada.
