...
%
%La versión de Segalá era en prosa y no una prosa para pusilánimes. 
...
%\footnote{\url{https://eolasediciones.es/libro/abandonando-itaca-leaving-ithaca/}}.
%En mi propia versión del mito de Odiseo, reinterpreto esencialmente toda la vida y la personalidad del héroe.
...
%Y resulta irónico que un texto del siglo VIII a.C. ofrezca una lectura inquietante y subversiva de Helena de Troya ---Homero dibuja una semidiosa amoral que sobrevive sin mayores remordimientos a la catástrofe que causó--- mientras que Nolan ofrece algo mucho más convencional y comercial a la vez: la víctima cuya cicatriz reconocemos y con la que podemos identificarnos. Exactamente igual que hace Petersen. ¿Para qué arriesgarse a que los espectadores crean que Héctor es un cobarde, si podemos suprimir la carrera?
...
% lo que le hace un personaje mucho menos interesante que el gamberro y malvado Polifemo, y la escena correspondiente es pura acción, sin apenas diálogo. En cambio, como veremos en el capítulo XVII, en la \emph{Odisea} Polifemo es \emph{casi} tan artero como Ulises.
% y empieza fingiendo hospitalidad:
%
%\begin{verse}
...
% ---el mismo Telémaco que ahorca a las criadas sin pestañear---. Circe, la de las largas trenzas, tiene algo de tabernera y Calipso, de traficante de drogas. Podría alegarse, sin embargo, que para gustos, los colores y también, sin mentir, que el conjunto es entretenido y bellamente filmado.
...
%A lo largo de este libro, con el permiso de sir Christopher, tendremos oportunidad de explicarnos las causas de ese miedo.

%Aun así, parafraseando a Borges, en la película hay algo que se queda. Se queda parte de la historia, una sombra de los personajes, una evocación más o menos afortunada de un tiempo y un lugar. Pero también hay algo que se queja. Y esa queja es casi inabarcable. Lo sé porque recuerdo al niño que se enamoró de Circe y de Nausícaa. Lo sé porque recuerdo la felicidad de leer a Homero y a Virgilio frente al vinoso Ponto; lo sé porque, afortunadamente, medio siglo después de mi primer encuentro con el Poeta, vuelvo a emocionarme hasta las lágrimas con la lectura de una nueva traducción de la \emph{Odisea} al castellano, debida a la pluma audaz de Juan Manuel Rodríguez Tobal.
%Pero de eso hablaré en la segunda parte de este ensayo.
