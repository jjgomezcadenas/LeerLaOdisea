...
%a la película, creo, le pasa lo mismo que a Héctor. Tiene miedo, en este caso no a Aquiles, sino al mismísimo Homero.
%
...
%¿Es lícito ese cambio de papeles? Nada lo impide a priori y, de hecho, en mi propio poema imagino a Polifemo como un muchacho gentil y ligeramente retardado\footnote{Y por si algún malpensado se lo está preguntando, \emph{Abandonando Ítaca} se escribió entre 2020 y 2023 y se publicó en 2025, un año antes de que se estrenara la \emph{Nodisea}.}. Pero no me limito a eso; también desarrollo el personaje y reinterpreto su relación con el taimado héroe. Todo lo que Nolan nos ofrece son unas escenas de acción, por lo demás, bien rodadas.
%
...
%
%Bueno, ¿y qué? Para gustos, los colores. Lo cierto es 
