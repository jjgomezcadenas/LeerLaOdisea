...
MI ALTERNATIVA: La escena nos reconcilia con el héroe milmañas, quizás por ser la primera vez que le vemos sufriendo genuinamente por el destino aciago de un pobre inocente. Pero a Odiseo aún le queda mucho sufrimiento por delante. La siguiente sombra en aparecer es su madre. Casi inmediatamente, Homero nos muestra que, compasión o no, Ulises es más duro de pelar que el bronce que esgrime
...
MI ALTERNATIVA: En la \emph{Odisea}, es Egisto ---no Clitemnestra--- quien lo mata, tendiéndole una emboscada que acaba en escabechina.
...
MI VERSION: Puede que no haga falta recurrir a la diosa ojiglauca para frenar las lanzas. \camb{Tal vez}, simplemente, Odiseo es un tipo afortunado, como se dirá a sí mismo, años más tarde, viejo y desengañado en Ítaca:
...
MI VERSION: Es decir, nada de matarlas a espada como han hecho con los pretendientes. Después de todo, estos eran nobles y varones y por tanto se merecían un pasaje en primera al Hades.
...
SI, excepto los dos puntos (mantener la coma ahí). 
